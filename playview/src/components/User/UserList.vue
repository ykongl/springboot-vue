...
<!--          搜索添加-->
          <label>用戶名：</label>
          <el-input placeholder="请输入搜索内容" v-model="queryInfo.username" clearable @click="getUserList" style="width: 30%; padding-right: 10px"/>
...
<!--      用户列表 border边框 Stripe隔行变色-->
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="賬號" prop="account" align="center"></el-table-column>
        <el-table-column label="電話號碼" prop="phone" align="center"></el-table-column>
...
<!--        自定义插槽-->
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <!--权限-->
            <el-tooltip effect="dark" content="权限管理" placement="top-start" :enterable="false">
